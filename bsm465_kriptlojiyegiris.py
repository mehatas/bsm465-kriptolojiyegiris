# -*- coding: utf-8 -*-
"""bsm465-kriptlojiyegiris.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1nzT_eSyVjj1c70iCo_g0VMNb9qHB5SSW
"""
...
blocks1 = split_blocks(all_ciphertext, 128)
all_org_text = ""
for i, block in enumerate(blocks1):
    ciphertext_block1 = decrypt_block(block,dec_keys[0])  # Şifre çözme işlemi gerçekleştiriliyor
    all_org_text += ciphertext_block1

# Şifrelenmiş metni string formatında ekrana yazdır
ciphertext_string = binary_to_string(all_ciphertext)
print(f"Şifrelenmiş Metin: {all_ciphertext}")
# Şifrelenmiş metni string formatında ekrana yazdır
all_org_text = binary_to_string(all_org_text)
print(all_org_text)